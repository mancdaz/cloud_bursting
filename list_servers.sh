...
# list servers
curl -s -H "x-auth-project-id: $OS_TENANT_ID" -H "x-auth-token: $OS_TOKEN" -H "Content-type: application/json" $NOVA_URL/v2/$OS_TENANT_ID/servers | python -mjson.tool|grep -i id|cut -d"\"" -f4
